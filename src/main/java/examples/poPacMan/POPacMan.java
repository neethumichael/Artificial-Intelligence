package main.java.examples.poPacMan;
...
public class POPacMan extends PacmanController {
    ...
    public MOVE getMove(Game game, long timeDue) {
            ...
            if (game.getGhostEdibleTime(ghost) == 0 && game.getGhostLairTime(ghost) == 0) {
                ...
                if (ghostLocation != -1) {
                    if (game.getShortestPathDistance(current, ghostLocation) < MIN_DISTANCE) {
                    	System.out.println("move away from target ghost");
        ...
        if (minGhost != null) {
        	System.out.println("move towards target ghost");
        ...
        if (!targets.isEmpty()) {
            ...
            System.out.println("move towards target");
