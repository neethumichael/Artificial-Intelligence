...
public class GainRatio 
{
  ...
  public GainRatio(HashMap<Integer, WeatherData> trainDataX, HashMap<Integer, WeatherData> trainDataY, String attribute,
			String target_val) {
		 ...
		 // System.out.println("going to create attr map");
		  XDataTrainAttrbMap = getHashByAttrib(XDataInTrain,attribute);
		  //System.out.println("created map...going to sort");
		 ...
		 // System.out.println("done sorting");
		  ...
		  int partitionPos = 0;
		  //System.out.println("going to find info gain to system");
		  ...
		  {  
			  ...
			  for(Feature f : featureData1)
			  {
				  ...
				  if(f.getName().contains(feature2consider))
					{
...
public double calculateGainRatio(double information_gain_System,String feature2consider, String target_val, HashMap<Integer,WeatherData>XDataInTrain,
  ...
  private HashMap<Integer,Double> getHashByAttrib(HashMap<Integer,WeatherData> XDataInTrain,String attrb)
  {
	  ...
	  //System.out.println("done going to return");
