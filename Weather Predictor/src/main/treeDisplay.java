...
public class treeDisplay extends JFrame {
	...
	public NodeDisp tree;
	public DrawTree drawer;
	
	/**
	 * Create the frame.
	 */
	public treeDisplay(NodeDisp tree) {
...
class DrawTree extends JPanel{
	...
	protected void paintComponent(Graphics g) {
		...
		DrawTree(g, 0, getWidth(), 0, getHeight() / heightOfTree(tree), tree);
	}
	
	public void DrawNode(Graphics g,NodeDisp n,int w,int h,int q){
		g.setFont(new Font("Tahoma", Font.BOLD, 20));
    ...
    public void DrawTree(Graphics g, int StartWidth, int EndWidth, int StartHeight, int Level, NodeDisp node) {
