...
public class Entropy {
	 ...
	 * @throws IOException
	 */
	public static double calculate(Feature target, ArrayList<WeatherData> instances) throws IOException{
	 ...
	 * @throws IOException
	 */
	public static double calculateConti(Feature target, ArrayList<WeatherData> instances, 
		...
		for (int i = start; i <= end; i++) {
			WeatherData instance = instances.get(i);
			HashMap<String, String> attributeValuePairsOfInstance = instance.getAttributeValuePairs();
			String valueOfInstanceAtTarget = attributeValuePairsOfInstance.get(targetName);
			if (!countValueOfTarget.containsKey(valueOfInstanceAtTarget)) 
				throw new IOException("Invalid input data");
